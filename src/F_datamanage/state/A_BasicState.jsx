...
export default function A_BasicState() {
  ...
  return (
    <div>
      ...
      <p>
        리액트에서 제공하는 함수를 이용 useState()함수 - 배열로 값,값을 수정할
        수 있는 함수반환 == {/*[값,함수]*/}
      </p>
      <p>
      ...
      <p>
        set메소드를 이용해서 수정 - 매개변수로 전달된 값으로 덮어쓰기함. -
        함수를 매개변수로 전달했을때 set메소드에서 반환하는 값으로 변수를
        덮어쓰기 함.
      </p>
      <ButtonComponent
        size="small"
      ...
      />
      <h3 className="text-lg font-bold m-2">{strData}</h3>
    </div>
  );
}
